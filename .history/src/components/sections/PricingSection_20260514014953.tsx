        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-4">
          {plans.map((plan) => {
            ...
            return (
              <div
                key={plan.id}
                className={`relative flex h-full flex-col rounded-[30px] border bg-white p-7 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl ${colors.border} ${colors.hover}`}
              >
                {/* Badge */}
                {plan.badge && (
                  <div
                ...
                {/* Button */}
                <button
                  className={`mt-auto w-full rounded-2xl px-5 py-3 font-semibold text-white transition-all duration-300 hover:opacity-90 ${colors.bg}`}
                >
                  এখনই শুরু করুন
                </button>
              </div>
          ...
          {/* Lifetime Card */}
          <div className="flex h-full flex-col rounded-[30px] border border-violet-200 bg-gradient-to-br from-white to-violet-50 p-7 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
            <div className="flex h-full flex-col justify-between">
              ...
              {/* Button */}
              <button className="mt-6 w-full rounded-2xl bg-violet-600 px-5 py-3 font-semibold text-white transition-all duration-300 hover:bg-violet-700">
