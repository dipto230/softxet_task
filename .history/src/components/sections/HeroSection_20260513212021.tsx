  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-4 py-20 lg:grid-cols-2 lg:px-8">
        <div>
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-violet-200 bg-white px-5 py-3 shadow-lg shadow-violet-100">
          ...
          <h1
            ref={titleRef}
            className="max-w-2xl text-5xl font-black leading-tight text-slate-900 lg:text-7xl"
          >
          ...
          >
            ...
            <button className="rounded-2xl border-2 border-violet-200 bg-white px-8 py-4 text-lg font-bold text-violet-700 transition-all duration-300 hover:border-violet-500 hover:bg-violet-50">
        ...
        <div ref={imageRef} className="relative">
          ...
          <div className="relative rounded-[40px] border border-white/30 bg-white/60 p-5 shadow-[0_20px_80px_rgba(124,58,237,0.2)] backdrop-blur-xl">
            <Image
              src="/hero.png"
              alt="Hero Image"
              width={900}
